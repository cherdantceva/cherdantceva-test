...
let components = JSON.parse(fs.readFileSync('components.json').toString());
...
const commonScssFilePath = path.join('src', 'common', 'common.scss');
...
commonJsContent = commonJsContent.replace(`import '../components/${componentName}/${componentName}';\n`, '');
